### It seems Cuckoo JSON reporting format as been modified and this project does not work anymore. I don't have time to maintain it but feel free to fork it to make it up to date.
